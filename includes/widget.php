...
function bvkld_render_widget() {
	...
	<div class="bvkld-wrap">
		...
		<div class="bvkld-box">
			<p class="bvkld-steps">
				<strong>1.</strong> <?php esc_html_e( 'Zvol částku', 'bvk-lightning-donate' ); ?>
				<span class="bvkld-dot">·</span>
				<strong>2.</strong> <?php esc_html_e( 'Klikni na „Poslat přes Lightning"', 'bvk-lightning-donate' ); ?>
			</p>
			...
			<div class="bvkld-amounts">
				...
				<button type="button" class="bvkld-amt bvkld-custom-toggle" data-sats="0">
					<?php esc_html_e( 'vlastní', 'bvk-lightning-donate' ); ?>
				</button>
			</div>

			<div class="bvkld-custom-input" hidden>
				<input type="number" min="1" step="1" class="bvkld-custom-amount"
					placeholder="<?php esc_attr_e( 'Zadej částku v sats', 'bvk-lightning-donate' ); ?>" />
			</div>

			<button type="button" class="bvkld-send">
				<span class="bvkld-send-label">⚡ <?php esc_html_e( 'Poslat přes Lightning', 'bvk-lightning-donate' ); ?></span>
				<span class="bvkld-send-loading" hidden><?php esc_html_e( 'Načítám…', 'bvk-lightning-donate' ); ?></span>
			</button>

			<div class="bvkld-error" role="alert" hidden></div>

			<div class="bvkld-qr-area" hidden>
				<p class="bvkld-qr-caption"><?php esc_html_e( 'Naskenuj QR mobilní Lightning peněženkou', 'bvk-lightning-donate' ); ?></p>
				<div class="bvkld-qr"></div>
				<button type="button" class="bvkld-invoice" title="<?php esc_attr_e( 'Klikni pro zkopírování', 'bvk-lightning-donate' ); ?>"></button>
			</div>

			<p class="bvkld-address-line">
				<?php esc_html_e( 'nebo pošli přímo na:', 'bvk-lightning-donate' ); ?>
				<button type="button" class="bvkld-address" title="<?php esc_attr_e( 'Klikni pro zkopírování', 'bvk-lightning-donate' ); ?>">
